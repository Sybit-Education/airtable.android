...
public class ListConverter extends AbstractConverter {
    ...
    @Override
    protected Object convertToType(Class type, Object value) throws InstantiationException, IllegalAccessException, InvocationTargetException  {
        ...
        if(value instanceof String){
            return toStringList(value.getClass(),value.toString(),returnList);
        }
        ...
        return toStringList(value.getClass(),stringValue,returnList);
    }
